	...
	public render() {
		return (
			<React.Fragment>
				...
				<div className={blockStyles.block}>
					<p className={blockStyles.block__title}> Authentication </p>
				...
				<p className={blockStyles.block__title}> Breaking changes </p>
					<p>
				...
				<div className={blockStyles.block}>
					<p className={blockStyles.block__title}> Using our documentation</p>
					<p>
					...
					<p className={blockStyles.block__title} style={{marginTop: 25}}> Getting Help </p>
